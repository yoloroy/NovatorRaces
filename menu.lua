...
menu.play = button:new(width/2-200, height/2 - 250, "bb_play.png")
menu.tuning = button:new(width/2-200, height/2 - 50, "bb_tuning.png")
menu.settings = button:new(width/2-200, height/2 + 150, "bb_settings.png")
menu.exit = button:new(width/2-200, height/2 + 350, "bb_exit.png")
...
function menu.mpress(x, y)
    if menu.play:mpress(x, y) then
        ...
        background11 = background:new(0, 0, {width, height}, {255, 255, 255, 255}, 
                                           {11520, 1048}, "track.png")
        background12 = background:new(0, 0, {width, height}, {255, 155, 155, 255}, 
                                           {7680, 493}, "forest.png", 15)
        background21 = background:new(0, 0, {width, height}, {255, 255, 255, 255}, 
                                           {11520, 1048}, "track.png")
        background22 = background:new(0, 0, {width, height}, {255, 155, 155, 255}, 
                                           {7680, 493}, "forest.png", 15)
    
        session1 = session:new(0,       0, car1, car2, background11, background12, "satrt.png", 1000*24, 0)
        session2 = session:new(width/2, 0, car2, car1, background21, background22, "satrt.png", 1000*24, 1)
